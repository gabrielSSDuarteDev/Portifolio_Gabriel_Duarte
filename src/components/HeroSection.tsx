    ...
    return (<section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4">
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="sapce-y-6">
                ...
                <p className="pt-4 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto opacity-0 animate-fade-in-dalay-3">
                    Desenvolvedor focado em construir soluções FrontEnd e Backend eficientes.
                    Utilizo os princípios da Engenharia de Software para transformar problemas complexos em sistemas funcionais e escaláveis.
                </p>
